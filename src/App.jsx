...
export default function App() {
  ...
  const handleSendMessage = async (e) => {
    ...
    setTimeout(() => {
      ...
      if (textLower.includes('chhale') || textLower.includes('chale') || textLower.includes('laar') || textLower.includes('lar') || textLower.includes('jhag') || textLower.includes('foam') || textLower.includes('saliva') || textLower.includes('mouth') || textLower.includes('fmd') || textLower.includes('छाले') || textLower.includes('झाग') || textLower.includes('लार') || textLower.includes('मुंह') || textLower.includes('छाते')) {
